...
parser.add_argument('--emb-file', required=True, help="Embeddings from this file, will often be Glove or Word2Vec")
parser.add_argument('--output-file', required=True, help="Pytorch embeddings into this file for the prepared data")
parser.add_argument('--vocab-file', required=True, help="Dictionary that maps a word to its embedding index")
parser.add_argument('--vocab-type', default='utterance', choices=['utterance', 'kb', 'cat', 'lf'], help='type of mapping being embedded into pytorch')
