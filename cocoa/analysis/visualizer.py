...
class Visualizer(object):
    ...
    def __init__(self, chats, surveys=None, worker_ids=None):
        ...
        if surveys:
            # 複数のバッチによるsurveysが行われる可能性があるため, これはリストである
    ...
    def read_eval(cls, surveys, mask=None):
        """
        question_scores[question][agent_type] は (dialogue_id, agent_id, ratings)のリスト
        """
