...
深層学習に基づくパーサーは、発話を話者の意図に基づくラベルに分類するタスクにおいて、約83%の分類正解率を達成しました。また、先行研究で用いられたルールベースのパーサーと比較して、分類不可となってしまう発話の割合を約25%から約0.8%まで減らし、発話をより正しく話者の意図に基づいて分類できることを示しました。
